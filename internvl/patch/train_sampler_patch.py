...
# patch trainer
def _get_sequence_train_sampler(self) -> Optional[torch.utils.data.Sampler]:
    if self.train_dataset is None or not has_length(self.train_dataset):
        return None
...
def replace_sequence_train_sampler():
    transformers.Trainer._get_train_sampler = _get_sequence_train_sampler
    print('Replace train sampler!!')