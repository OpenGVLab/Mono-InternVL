...
class InternVLChatModel(PreTrainedModel):
    ...
    def __init__(self, config: InternVLChatConfig, vision_model=None, language_model=None):
        ...
        elif 'intern_vit_6b' in config.vision_config.model_type:
            self.vision_model = InternVisionModel(config.vision_config)
        elif 'intern_vit_patch' in config.vision_config.model_type:
        ...
        self.language_arch=config.llm_config.architectures[0]
    ...
    def forward(
        ...
        if self.language_arch=='InternLM2VEForCausalLM':
        ...
        return CausalLMOutputWithVisualMask(
            loss=loss,
            logits=logits,
    ...
    def generate(
        ...
        if pixel_values is not None:
            ...
            input_embeds = self.language_model.get_input_embeddings()(input_ids)
            visual_token_mask = torch.zero_like(input_ids).reshape(B,N,1)
