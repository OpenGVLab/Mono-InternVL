...
def get_unwapper_train_dataloader(self) -> DataLoader:
    """
    Returns the training [`~torch.utils.data.DataLoader`].
...
def replace_unwapper_train_dataloader():
    transformers.Trainer.get_train_dataloader = get_unwapper_train_dataloader
    print('Replace train dataloader!!')